...
- (void)viewDidLoad
{
    ...
    QEDTextView *textView = [[QEDTextView alloc] initWithFrame:CGRectMake(0, 40,rx.size.width, rx.size.height)];
    ...
    self.search=[[UISearchBar alloc]initWithFrame:CGRectMake(0,60, rx.size.width, 40)];
    self.search.prompt=@"搜索框";
